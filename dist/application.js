...
myApp.service('myAppCart', function(localStorageService) {
	return {
...
myApp.controller('PhoneCtrl',function($scope, phoneFactory, phoneDataService) {
...
myApp.controller('PlansCtrl', function($scope, planFactory, planDataService, $document) {
...
myApp.controller('CartCtrl',function($scope,myAppCart) {
